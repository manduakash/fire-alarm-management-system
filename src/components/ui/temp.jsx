...
export function Charts() {
  return (
    <div className="chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 sm:flex-row sm:p-8">
      <div className="grid w-1/3 gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
        <Card
      ...
      <div className="grid w-1/3 flex-1 gap-6 lg:max-w-[20rem]">
        <Card
